...
//   SquareData(
//     ChessPiece(type: 'rook', color: 'white', currentPosition: const Coordinate(file: 0, rank: 7)),
//     coordinate: const Coordinate(file: 0, rank: 7),
//   ),
//   SquareData(
//     ChessPiece(type: 'knight', color: 'white', currentPosition: const Coordinate(file: 1, rank: 7)),
//     coordinate: const Coordinate(file: 1, rank: 7),
//   ),
//   SquareData(
//     ChessPiece(type: 'bishop', color: 'white', currentPosition: const Coordinate(file: 2, rank: 7)),
//     coordinate: const Coordinate(file: 2, rank: 7),
//   ),
//   SquareData(
//     ChessPiece(type: 'queen', color: 'white', currentPosition: const Coordinate(file: 3, rank: 7)),
//     coordinate: const Coordinate(file: 3, rank: 7),
//   ),
//   SquareData(
//     ChessPiece(type: 'king', color: 'white', currentPosition: const Coordinate(file: 4, rank: 7)),
//     coordinate: const Coordinate(file: 4, rank: 7),
//   ),
//   SquareData(
//     ChessPiece(type: 'bishop', color: 'white', currentPosition: const Coordinate(file: 5, rank: 7)),
//     coordinate: const Coordinate(file: 5, rank: 7),
//   ),
//   SquareData(
//     ChessPiece(type: 'knight', color: 'white', currentPosition: const Coordinate(file: 6, rank: 7)),
//     coordinate: const Coordinate(file: 6, rank: 7),
//   ),
//   SquareData(
//     ChessPiece(type: 'rook', color: 'white', currentPosition: const Coordinate(file: 7, rank: 7)),
...
//   SquareData(
//     ChessPiece(type: 'rook', color: 'black', currentPosition: const Coordinate(file: 0, rank: 0)),
//     coordinate: const Coordinate(file: 0, rank: 0),
//   ),
//   SquareData(
//     ChessPiece(type: 'knight', color: 'black', currentPosition: const Coordinate(file: 1, rank: 0)),
//     coordinate: const Coordinate(file: 1, rank: 0),
//   ),
//   SquareData(
//     ChessPiece(type: 'bishop', color: 'black', currentPosition: const Coordinate(file: 2, rank: 0)),
//     coordinate: const Coordinate(file: 2, rank: 0),
//   ),
//   SquareData(
//     ChessPiece(type: 'queen', color: 'black', currentPosition: const Coordinate(file: 3, rank: 0)),
//     coordinate: const Coordinate(file: 3, rank: 0),
//   ),
//   SquareData(
//     ChessPiece(type: 'king', color: 'black', currentPosition: const Coordinate(file: 4, rank: 0)),
//     coordinate: const Coordinate(file: 4, rank: 0),
//   ),
//   SquareData(
//     ChessPiece(type: 'bishop', color: 'black', currentPosition: const Coordinate(file: 5, rank: 0)),
//     coordinate: const Coordinate(file: 5, rank: 0),
//   ),
//   SquareData(
//     ChessPiece(type: 'knight', color: 'black', currentPosition: const Coordinate(file: 6, rank: 0)),
//     coordinate: const Coordinate(file: 6, rank: 0),
//   ),
//   SquareData(
//     ChessPiece(type: 'rook', color: 'black', currentPosition: const Coordinate(file: 7, rank: 0)),
